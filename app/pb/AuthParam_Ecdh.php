...
namespace {
/**
 * Ecdh message embedded in AuthParam message
 */
class AuthParam_Ecdh extends \ProtobufMessage
{
     ...
     *
     * @param \AuthParam_Ecdh_EcdhKey $value Property value
     *
     * @return null
     */
    public function setEcdhKey(\AuthParam_Ecdh_EcdhKey $value=null)
    {
